...
#####
#oneMinute = 60
#interval = 5 * oneMinute  # in seconds
interval = 5
compData = {}
companyData = {}
        ...
        for item in companyData:
            ...
            self.companyData_StringVar[item].set(
                '  {:<5}\t{:>8.2f}\t{:>6.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t{:>16}\t{:>16}'.format(
                    ...
                    companyData[item]['ret90'], str(companyData[item]['vol']), str(companyData[item]['volAvg'])))
    ...
    def OnButtonClick(self, button_id):
        ...
        T.insert(END,
                 '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n\n'.format(
                     ...
                     str(companyData[button_id]['vol']), str(companyData[button_id]['volAvg'])))
        ...
        T.insert(END,
                 '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n'.format(
                     str(companyData[button_id]['comp1']), compData[companyData[button_id]['comp1']]['last'],
                     compData[companyData[button_id]['comp1']]['change'],
                     compData[companyData[button_id]['comp1']]['pctChange'],
                     compData[companyData[button_id]['comp1']]['ret1'],
                     compData[companyData[button_id]['comp1']]['ret7'],
                     compData[companyData[button_id]['comp1']]['ret30'],
                     compData[companyData[button_id]['comp1']]['ret90'],
                     str(compData[companyData[button_id]['comp1']]['vol']),
                     str(compData[companyData[button_id]['comp1']]['volAvg'])))
        ...
        if 'comp2' in companyData[button_id].keys() and companyData[button_id]['comp2'] != '':
            T.insert(END,
                     '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n'.format(
                         str(companyData[button_id]['comp2']), compData[companyData[button_id]['comp2']]['last'],
                         compData[companyData[button_id]['comp2']]['change'],
                         compData[companyData[button_id]['comp2']]['pctChange'],
                         compData[companyData[button_id]['comp2']]['ret1'],
                         compData[companyData[button_id]['comp2']]['ret7'],
                         compData[companyData[button_id]['comp2']]['ret30'],
                         compData[companyData[button_id]['comp2']]['ret90'],
                         str(compData[companyData[button_id]['comp2']]['vol']),
                         str(compData[companyData[button_id]['comp2']]['volAvg'])))
        ...
        if 'comp3' in companyData[button_id].keys() and companyData[button_id]['comp3'] != '':
            T.insert(END,
                     '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n'.format(
                         str(companyData[button_id]['comp3']), compData[companyData[button_id]['comp3']]['last'],
                         compData[companyData[button_id]['comp3']]['change'],
                         compData[companyData[button_id]['comp3']]['pctChange'],
                         compData[companyData[button_id]['comp3']]['ret1'],
                         compData[companyData[button_id]['comp3']]['ret7'],
                         compData[companyData[button_id]['comp3']]['ret30'],
                         compData[companyData[button_id]['comp3']]['ret90'],
                         str(compData[companyData[button_id]['comp3']]['vol']),
                         str(compData[companyData[button_id]['comp3']]['volAvg'])))
        ...
        if 'comp4' in companyData[button_id].keys() and companyData[button_id]['comp4'] != '':
            T.insert(END,
                     '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n'.format(
                         str(companyData[button_id]['comp4']), compData[companyData[button_id]['comp4']]['last'],
                         compData[companyData[button_id]['comp4']]['change'],
                         compData[companyData[button_id]['comp4']]['pctChange'],
                         compData[companyData[button_id]['comp4']]['ret1'],
                         compData[companyData[button_id]['comp4']]['ret7'],
                         compData[companyData[button_id]['comp4']]['ret30'],
                         compData[companyData[button_id]['comp4']]['ret90'],
                         str(compData[companyData[button_id]['comp4']]['vol']),
                         str(compData[companyData[button_id]['comp4']]['volAvg'])))
        ...
        if 'comp5' in companyData[button_id].keys() and companyData[button_id]['comp5'] != '':
            T.insert(END,
                     '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n'.format(
                         str(companyData[button_id]['comp5']), compData[companyData[button_id]['comp5']]['last'],
                         compData[companyData[button_id]['comp5']]['change'],
                         compData[companyData[button_id]['comp5']]['pctChange'],
                         compData[companyData[button_id]['comp5']]['ret1'],
                         compData[companyData[button_id]['comp5']]['ret7'],
                         compData[companyData[button_id]['comp5']]['ret30'],
                         compData[companyData[button_id]['comp5']]['ret90'],
                         str(compData[companyData[button_id]['comp5']]['vol']),
                         str(compData[companyData[button_id]['comp5']]['volAvg'])))
        ...
        if 'comp6' in companyData[button_id].keys() and companyData[button_id]['comp6'] != '':
            T.insert(END,
                     '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n'.format(
                         str(companyData[button_id]['comp6']), compData[companyData[button_id]['comp6']]['last'],
                         compData[companyData[button_id]['comp6']]['change'],
                         compData[companyData[button_id]['comp6']]['pctChange'],
                         compData[companyData[button_id]['comp6']]['ret1'],
                         compData[companyData[button_id]['comp6']]['ret7'],
                         compData[companyData[button_id]['comp6']]['ret30'],
                         compData[companyData[button_id]['comp6']]['ret90'],
                         str(compData[companyData[button_id]['comp6']]['vol']),
                         str(compData[companyData[button_id]['comp6']]['volAvg'])))
        ...
        if 'comp7' in companyData[button_id].keys() and companyData[button_id]['comp7'] != '':
            T.insert(END,
                     '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n'.format(
                         str(companyData[button_id]['comp7']), compData[companyData[button_id]['comp7']]['last'],
                         compData[companyData[button_id]['comp7']]['change'],
                         compData[companyData[button_id]['comp7']]['pctChange'],
                         compData[companyData[button_id]['comp7']]['ret1'],
                         compData[companyData[button_id]['comp7']]['ret7'],
                         compData[companyData[button_id]['comp7']]['ret30'],
                         compData[companyData[button_id]['comp7']]['ret90'],
                         str(compData[companyData[button_id]['comp7']]['vol']),
                         str(compData[companyData[button_id]['comp7']]['volAvg'])))
        ...
        if 'comp8' in companyData[button_id].keys() and companyData[button_id]['comp8'] != '':
            T.insert(END,
                     '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n'.format(
                         str(companyData[button_id]['comp8']), compData[companyData[button_id]['comp8']]['last'],
                         compData[companyData[button_id]['comp8']]['change'],
                         compData[companyData[button_id]['comp8']]['pctChange'],
                         compData[companyData[button_id]['comp8']]['ret1'],
                         compData[companyData[button_id]['comp8']]['ret7'],
                         compData[companyData[button_id]['comp8']]['ret30'],
                         compData[companyData[button_id]['comp8']]['ret90'],
                         str(compData[companyData[button_id]['comp8']]['vol']),
                         str(compData[companyData[button_id]['comp8']]['volAvg'])))
        ...
        if 'comp9' in companyData[button_id].keys() and companyData[button_id]['comp9'] != '':
            T.insert(END,
                     '  {:<5}\t{:>10.2f}\t{:>8.2f}\t{:>8.2f}\t\t{:>6.2f}\t{:>6.2f}\t{:>6.2f}\t  {:>6.2f}\t  {:>16}\t{:>16}\n'.format(
                         str(companyData[button_id]['comp9']), compData[companyData[button_id]['comp9']]['last'],
                         compData[companyData[button_id]['comp9']]['change'],
                         compData[companyData[button_id]['comp9']]['pctChange'],
                         compData[companyData[button_id]['comp9']]['ret1'],
                         compData[companyData[button_id]['comp9']]['ret7'],
                         compData[companyData[button_id]['comp9']]['ret30'],
                         compData[companyData[button_id]['comp9']]['ret90'],
                         str(compData[companyData[button_id]['comp9']]['vol']),
                         str(compData[companyData[button_id]['comp9']]['volAvg'])))
...
def update_data(mainobject):
    ...
    for item in mainobject.allStocksList:
        ...
        if item in companyData:
            ...
            companyData[item]['pctChange'] = round(companyData[item]['change'] / companyData[item]['prevClose'] * 100,
                                                   2)
